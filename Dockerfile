...
RUN apt-get -y install php7.4 php7.4-cli php7.4-redis php7.4-curl php7.4-gd php7.4-mbstring php7.4-imagick php7.4-mysql php7.4-xdebug php7.4-simplexml php7.4-zip php7.4-soap php7.4-apcu php-apcu-bc php7.4-sqlite3 php7.4-intl php7.4-bcmath
